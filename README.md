...
```
npm create cloudflare@latest -- --template=cloudflare/templates/snowy-dew-02ae
```

## Preview Deployment

A live public deployment of this template is available at [https://snowy-dew-02ae.templates.workers.dev](https://snowy-dew-02ae.templates.workers.dev)
